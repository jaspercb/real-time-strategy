...
class Spritesheet{
	...
	public:
		Spritesheet(SDL_Texture* src, int w, int h, int offX = 0, int offY = 0, int gX = 0, int gY = 0);

		Spritesheet(SDL_Renderer* renderer, const char* src, int w, int h, int offX = 0, int offY = 0, int gX = 0, int gY = 0);
